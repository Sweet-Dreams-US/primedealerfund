...
export const mayPosts: BlogPost[] = [
  {
    ...
    content: [
      {
        type: "paragraph",
        text: "Coleman Prime Automotive LLC, the joint venture between Prime Dealer Equity Fund LLC and Coleman Automotive Group LLC, today announced the closing of its acquisition of McGrath Nissan of Elgin. The dealership will operate going forward as Nissan of Elgin.",
      },
      {
        type: "paragraph",
